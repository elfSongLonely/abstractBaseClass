...
{
	if (amt < 0)
		cout << "Negative deposit not allowed; deposit is canncelled." << endl;
	else
		balance += amt;
...
void Brass::Withdraw(double amt)
{
	if (amt < 0)
		...
		cout << "Withdrawal amount of $" << amt << " exceeds your balancce." << endl << "Withdrawal canncelled." << endl;
}
...
void BrassPlus::Withdraw(double amt)
{
	...
	else if (amt <= bal + maxLoan - owesBank)
	{
		...
		cout << "Credit mimit exceeded.Transaction canncelled." << endl;
	Restore(f);
}